...
let usersScan = users.filter(dateS => dateS.registrationDate == '10.10.2021' || dateS.registrationDate == '09.10.2021'
)
for (let i = 0; i < usersScan.length; i++) {
    console.log(usersScan[i].firstName + ' ' + usersScan[i].lastName)
}
